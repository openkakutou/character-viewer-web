/**
 * This app's own i18n setup (backlog item 018): wires the shared
 ...
 * contract. See `.vibe/decisions/019-i18n-integration-approach.md` for why
 ...
 * i18next lookup -- that property is what lets the existing test suite keep
 * asserting plain English text without every test file bootstrapping i18n
 * itself. Ported from the six sibling repos' own identical `src/i18n/i18n.ts`
 * (`stage-viewer-web`, `stage-editor`, `lifebar-viewer-web`, `lifebar-editor`,
 * `character-editor`, `mode-quick-versus`).
 */
import {
  type I18nInstance,
  type LocaleCatalogs,
...
export const NAMESPACE = "character-viewer-web";
 ...
 */
const STORAGE_KEY = "character-viewer-web-locale";
