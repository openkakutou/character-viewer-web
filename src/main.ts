 ...
 * (backlog item 003), and the characteristics panel (backlog item 004) plus
 * the sprite browser (backlog item 005) as the main content, both appearing
 * automatically once a character loads — see
