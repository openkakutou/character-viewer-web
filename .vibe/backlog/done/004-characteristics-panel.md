...
## Acceptance Criteria
- [x] After loading a valid character, the panel displays its name
- [x] The panel displays the total animation count and total sprite count
- [x] The panel lists every Statedef number present in the loaded character
- [x] Loading a character with zero animations/sprites/states displays that explicitly (e.g. "0"), not a blank or broken section
