...
## Acceptance Criteria
- [x] Author/credit fields, when present, are displayed in the characteristics panel
- [x] Missing/empty metadata fields degrade gracefully (no blank crash, no "undefined" shown)
