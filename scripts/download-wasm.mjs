...
// openkakutou/character for a pinned version tag, replacing the previous
// local-build workaround (sibling checkout + Go toolchain). See
// .vibe/backlog/done/001-wasm-release-download-script.md and
// .vibe/decisions/001-wasm-download-script-design.md.
 ...
 * never leaves a truncated file behind — see decision 001.
 */
